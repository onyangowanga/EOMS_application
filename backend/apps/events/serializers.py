...
class EventMemberSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_official', 'is_executive', 'has_super_admin_rights', 
            'can_approve_expenses', 'can_manage_roles', 'can_create_tasks',
...
class BudgetItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'status', 'status_display', 'created_by', 'created_by_details', 'created_by_name',
    ...
    def get_created_by_name(self, obj):
        ...
        if obj.linked_task_id:
            return 'Autogenerated from task'
        return None
...
class BudgetItemListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = BudgetItem
        fields = [
            'id', 'event_name', 'committee_name', 'linked_task', 'linked_task_title', 'item_name', 'category',
...
class BudgetItemCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = BudgetItem
        fields = [
            'event', 'committee', 'linked_task', 'item_name', 'description', 'category',
            'allocated_amount'
        ]
